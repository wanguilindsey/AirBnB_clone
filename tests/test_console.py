...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_show(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertIn(h.strip(), actual_output)
    ...
    def test_help_all(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            actual_output = output.getvalue().strip().splitlines()
            ...
            for phrase in key_phrases:
                ...
                self.assertTrue(any(phrase in line for line in actual_output), f"Failed for phrase: {phrase}")

        self.assertEqual(len(key_phrases), len(actual_output), "Number of lines mismatch")
